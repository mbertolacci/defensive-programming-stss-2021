...
<aside class="notes">
  ...
  And a final point, don't feel the need to check every tiny assumptions. Just the most important ones, and the ones that end up catching you.
  </div>
</aside>
...
- Automated testing. See:
  - Wikipedia on **unit testing** [[6]](#/resources)
  - The **`testthat`** package in R [[7]](#/resources)
  - The **`pytest`** framework for Python [[8]](#/resources)
- Internal peer review:
  - Can a coauthor or a friend **read your code** for you?
- Automated checking for common bugs:
  - The **`pylint`** program can do this for Python [[9]](#/resources).
...
<div style="text-align: left; font-size: 0.6em">
  ...
  [6] Wikipedia contributors. (2021, January 23). Unit Testing. In *Wikipedia, The Free Encyclopedia*. Retrieved 00:49, February 17, 2021, from https://en.wikipedia.org/w/index.php?title=Unit_testing&oldid=1002146431<br />
  [7] Wickham, H., Bryan, J. (2021). *R Packages* (2nd ed.). Published online at [https://r-pkgs.org/index.html](https://r-pkgs.org/index.html). <br />
  [8] Krekel, H., and other contributors, (2021). pytest. [https://docs.pytest.org/en/stable/](https://docs.pytest.org/en/stable/). <br />
  [9] Logilab, (2021). pylint. [https://www.pylint.org/](https://www.pylint.org/).
</div>
